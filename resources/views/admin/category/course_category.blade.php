						...
						<form>
							...
							<label class="col-lg-4 col-xl-4 col-xxl-4 col-form-label">No Of Category</label>
							  <div class="col-lg-4 col-xl-4 col-xxl-4">
								<input type="number" id="cat_count" class="form-control mb-3" required>
							  </div>
							   <div class="col-lg-4 col-xl-4 col-xxl-4">
                               ...
                               <tbody>
                                   <tr>
									...
									<td class="no-content">
										...
										<a href="javascript:void(0)" class="btnDel btn btn-danger btn-rect btn-xs btn-sm fap pr8" title="Delete" ><i class="fa fa-trash"></i></a>
									</td>
								</tr>
								
								<tr>
									<td>2</td>
									<td>PLUS-TWO Level</td>
									<td><span class="badge bg-success">Active</span></td>
									<td class="no-content">
										<a href="javascript:void(0)" class="btnEdit btn btn-primary btn-rect btn-xs btn-sm fap" data-bs-toggle="modal" data-bs-target="#BasicModal2"  title="Edit course" ><i class="fa fa-edit"></i></a>
										<a href="javascript:void(0)" class="btnDel btn btn-danger btn-rect btn-xs btn-sm fap pr8" title="Delete" ><i class="fa fa-trash"></i></a>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<label>Category</label>
					  <input class="form-control mb-3" type="text" placeholder="Categories" value="10th LEVEL" required>
					</div>
					</div>
					</div>
		...
		for(x=1;x<=scnt;x++)
		{
			...
			sub+='<div class="form-group">\
				...
				<div class="col-lg-12 col-xl-12 col-xxl-12">\
					...
					<input type="text" name="category"'+x+' class="form-control mb-3" placeholder="category-'+x+'" required>\
				</div>\
				</div>\
				</div>';	
		}
