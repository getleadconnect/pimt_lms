...
<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
              <div class="breadcrumb-title pe-3">Add Question Bank Questions(Text/Image)</div>
                ...
                <div class="card-body">
                   ...
                   <div class="row mt-2">
                     <div class="col-8 col-lg-8 col-xxl-8col-xl-8">
							<form  method="POST" action="{{route('save-qbank-question')}}" enctype="multipart/form-data" >
							@csrf
							...
							<div class="form-group">
								...
								<div class="col-lg-4 col-xl-4 col-xxl-4 ">
									<div class="form-check">
										...
										<label class="form-check-label" for="free_test_edit2" style="font-weight:500;">&nbsp;&nbsp;OBJECTIVE/DESCRIPTIVE</label>
									</div>
								</div>
							...
							<div class="form-group hide" id="quest"  style="width:100%;">
								<div class="row">
									...
									<div class="col-md-2 col-xl-2 col-xxl-2">
										<label>Question Type</label>
										<select class="form-control mb-3" id="quest_type" name="quest_type" placeholder="question_type" >
											<option value="">select</option>
							...
							<div class="form-group show" id="img_quest"  style="width:100%;">
								...
								<input class="form-control mb-3" type="file" id="image_question" name="image_question" placeholder="image question" >
							</div>
							...
							<div class="col-lg-4 col-xl-4 col-xxl-4">
								...
								<select class="form-control mb-3" name="correct_answer" id="correct_answer" required>
								<option value="">--select--</option>
...
$("#quest_type").change(function(){
	...
	if($(this).val()==0)
	{
		$("#ans_Set").prop('disabled',false);
		$("#correct_answer").prop('disabled',false);
	}
	else
	{
		$("#ans_Set").prop('disabled',true);
...
$(".quest_option").change(function()
{
	...
	if(vl==1)
	{
		...
		$("#quest_type").prop('required',false);
		$("#question").prop('required',false);
	}
	else
	{
