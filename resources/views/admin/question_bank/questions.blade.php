              ...
              <div class="card">
				...
				<div class="col-lg-9 col-xl-9 col-xxl-9 col-9">
				  ...
				  <div class="col-lg-3 col-xl-3 col-xxl-3 col-3 text-right">
				   ...
				   <a href="{{route('add-qbank-question')}}" class="btn btn-primary btn-xs btn-sm" ><i class="fa fa-plus"></i>&nbsp;Add Question</a>
				  </div>
                          ...
                          <div class="accordion-body">
						   <div class="row" style="padding:3px 10px 0px 10px;" >
							...
							<div class="col-3 col-lg-3">
								<label>Subject</label>
								<select class="form-control mb-3" id="flt_subject_id" placeholder="subject" required>
							...
							<div class="col-3 col-lg-2">
								...
								<select class="form-control mb-3" id="flt_question_type" placeholder="Question Type" required>
								<option value="">select</option>
...
var table = $('#datatable').DataTable({
		...
		ajax:
		{
			url:"view-qbank-questions",
			data: function (data) 
		    {
               data.search = $('input[type="search"]').val();
			   data.searchSubjectId = $("#flt_subject_id").val();
			   data.questionTypeId = $("#flt_question_type").val();
		    },
        },
...
$("#flt_question_type").change(function()
{
	$('#datatable').DataTable().ajax.reload(null, false);
});
