...
<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
              <div class="breadcrumb-title pe-3">PDF Files</div>
            ...
            <!--end breadcrumb-->
              ...
              <div class="card">
				...
				<div class="col-lg-9 col-xl-9 col-xxl-9 col-9">
                  <h6 class="mb-0 pt5">File List</h6>
				  </div>
				  ...
				  <button class="btn btn-info btn-xs btn-sm" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" style="padding-left:3px;" aria-expanded="true" aria-controls="flush-collapseOne">
					...
					<a href="{{url('add-pdf-file')}}" class="btn btn-primary btn-xs btn-sm" ><i class="fa fa-plus"></i>&nbsp;Add Pdf Files</a>
				  </div>
                          ...
                          <div class="accordion-body">
						   <div class="row" style="padding:3px 10px 0px 10px;" >
							<div class="col-3 col-lg-3">
								<label>Course</label>
								<select class="form-control mb-3" id="flt_center" placeholder="course" >
							...
							<div class="col-3 col-lg-3">
								<label>Subject</label>
								<select class="form-control mb-3" id="flt_subject" placeholder="subjects" >
								<option value="">select</option>
								@foreach($subj as $r)
							...
							<div class="col-3 col-lg-3">
								...
								<select class="form-control mb-3" id="flt_chapter" placeholder="chapter" >
								<option value="">select</option>
								@foreach($chap as $r)
...
var table = $('#datatable').DataTable({
		...
		ajax:
		{
			...
			data: function (data) 
		    {
			   ...
			   data.searchChapter = $('#flt_chapter').val();
		    },
        },
