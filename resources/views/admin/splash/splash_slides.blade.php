...
<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
              <div class="breadcrumb-title pe-3">Splash Slides</div>
            ...
            <!--end breadcrumb-->
              ...
              <div class="card">
				...
				<div class="col-lg-9 col-xl-9 col-xxl-9 col-9">
                  <h6 class="mb-0 pt5">Slides List</h6>
				  </div>
				  <div class="col-lg-3 col-xl-3 col-xxl-3 col-3 text-right">
                  <button type="button" class="btn btn-primary btn-xs btn-sm" data-bs-toggle="modal" data-bs-target="#BasicModal1"><i class="fa fa-plus"></i>&nbsp;Add Slides</button>
				  </div>
			...
			<div class="modal fade" id="BasicModal1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<form method="POST" action="{{url('save-splash-slide')}}" enctype="multipart/form-data">
						@csrf
						...
						<select class="form-control mb-3" name="slide_position" placeholder="select file">
						...
						<input type="file" class="form-control mb-3" placeholder="select file" id="slide_image" name="slide_image" required>
						</div>
...
slide_image.onchange = evt => {
  const [file] = slide_image.files
	...
	Swal.fire({
	  ...
	  if (result.isConfirmed) {
		var id=$(this).attr('id');
		  jQuery.ajax({
			type: "get",
			url: "act-deact-splash-slide/1"+"/"+id,
			dataType: 'json',
			//data: {vid: vid},
			success: function(res)
			{
	...
	Swal.fire({
	  ...
	  if (result.isConfirmed) {
		var id=$(this).attr('id');
		  jQuery.ajax({
			type: "get",
			url: "act-deact-splash-slide/2"+"/"+id,
			dataType: 'json',
			//data: {vid: vid},
			success: function(res)
			{
