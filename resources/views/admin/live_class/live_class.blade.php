...
<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
              <div class="breadcrumb-title pe-3">Live Classes</div>
            ...
            <!--end breadcrumb-->
              ...
              <div class="card">
				...
				<div class="col-lg-9 col-xl-9 col-xxl-9 col-9">
                  <h6 class="mb-0 pt5">Live class List </h6>
				  </div>
                  ...
                  <button type="button" class="btn btn-primary btn-xs btn-sm" data-bs-toggle="modal" data-bs-target="#BasicModal1"><i class="fa fa-plus"></i>&nbsp;Add Live Class</button>
				  </div>
                          ...
                          <div class="accordion-body">
						   <div class="row" style="padding:3px 10px 0px 10px;" >
							...
							<div class="col-3 col-lg-3">
								<label>Course</label>
								<select class="form-control mb-3"  id="flt_course" placeholder="Course" >
							...
							<div class="col-3 col-lg-3">
								<label>Subject</label>
								<select class="form-control mb-3" id="flt_subject" placeholder="Course" >
								<option value="">select</option>
								@foreach($subj as $r)
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title" id="exampleModalLabel">Add live class link</h5>
						...
						<form method="POST" action="{{url('save-live-class')}}" enctype="multipart/form-data">
						@csrf
						...
						<select class="form-control mb-3" id="subject_id" name="subject_id" placeholder="subjects" required>
						<option value="">select</option>
						...
						<input type="text" class="form-control mb-3" id="conducted_by" name="conducted_by" placeholder="name" required>
						</div>
						</div>
						</div>
						...
						<div class="form-group">
							...
							<textarea class="form-control mb-3" type="text" name="class_link" placeholder="Meeting link"  required></textarea>
							</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<input class="form-control mb-3" type="time" name="start_time" placeholder="start time" required>
							</div>
							<div class="col-lg-4 col-xl-4 col-xxl-4">
							<label>End Time</label>
							<input class="form-control mb-3" type="time" name="end_time" placeholder="end time" required>
							</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<input class="form-control mb-3" type="file" id="class_icon" name="class_icon" placeholder="select file" required>
							</div>
...
class_icon.onchange = evt => {
  const [file] = class_icon.files
...
var table = $('#datatable').DataTable({
		...
		ajax:
		{
			...
			data: function (data) 
		    {
			   ...
			   data.searchSubject = $('#flt_subject').val();
