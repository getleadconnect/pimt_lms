            ...
            <!--end breadcrumb-->
              ...
              <div class="card">
				...
				<div class="col-lg-9 col-xl-9 col-xxl-9 col-9">
                  <h6 class="mb-0 pt5">Chapters List</h6>
				  </div>
                  ...
                  <button type="button" class="btn btn-primary btn-xs btn-sm" data-bs-toggle="modal" data-bs-target="#BasicModal1"><i class="fa fa-plus"></i>&nbsp;Add Chapter</button>
				  </div>
                          ...
                          <div class="accordion-body">
						   <div class="row" style="padding:3px 10px 0px 10px;" >
							...
							<div class="col-3 col-lg-3">
								...
								<select class="form-control mb-3" id="flt_subject" placeholder="subject" >
								<option value="">select</option>
								@foreach($subj as $r)
			...
			<div class="modal fade" id="BasicModal1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<form method="POST" action="{{url('save-chapter')}}" enctype="multipart/form-data">
						@csrf
						<div class="form-group">
						<label>Course</label>
						<select class="form-control mb-3" name="course_id" id="course_id" required>
						<option value="">Select</option>
						@foreach($crs as $r)
						<option value="{{$r->id}}">{{$r->course_name}}</option>
						@endforeach
						...
						<select class="form-control mb-3" name="subject_id" id="subject_id" required>
						<option value="">Select</option>
						...
						<input class="form-control mb-3" type="text" name="chapter_name" placeholder="Chapter name" required>
						</div>
						...
						<input type="file" class="form-control mb-3" id="chapter_icon" name="chapter_icon"  placeholder="icon" required>
						</div>
...
chapter_icon.onchange = evt => {
  const [file] = chapter_icon.files
