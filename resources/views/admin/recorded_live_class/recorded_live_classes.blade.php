...
<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
              <div class="breadcrumb-title pe-3">Recorded Live Class</div>
            ...
            <!--end breadcrumb-->
              ...
              <div class="card">
				...
				<div class="col-lg-9 col-xl-9 col-xxl-9 col-9">
                  <h6 class="mb-0 pt5">Class List</h6>
				  </div>
				  ...
				  <button type="button" class="btn btn-primary btn-xs btn-sm" data-bs-toggle="modal" data-bs-target="#BasicModal1"><i class="fa fa-plus"></i>&nbsp;Add Recorded Class</button>
				  </div>
                          ...
                          <div class="accordion-body">
						   <div class="row" style="padding:3px 10px 0px 10px;" >
							<div class="col-3 col-lg-3">
								<label>Course</label>
								<select class="form-control mb-3" id="flt_course" placeholder="Course type" >
			  ...
			  <div class="modal fade" id="BasicModal1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
				 ...
				 <div class="modal-dialog">
				    <div class="modal-content">
						...
						<form method="POST" action="{{url('save-recorded-live-class')}}" enctype="multipart/form-data">
						@csrf
						...
						<label>Class Icon</label>
						  <input type="file" class="form-control mb-3" placeholder="select file" id="class_icon" name="class_icon" required>
						</div>
						...
						<div class="col-lg-11 col-xl-11 col-xxl-11">
						   ...
						   <input type="file" class="form-control mb-3" onchange="fileValidation()" placeholder="select file" id="video_file" name="video_file" required>
						</div>
						</div>
						</div>
						...
						<div class="col-lg-4 col-xl-4 col-xxl-4">
						  ...
						  <input type="text" class="form-control" placeholder="2:30:00" id="duration" name="duration" required>
						  <span>Eg: 2:30:00</span>
						</div>
						
						<div class="col-lg-8 col-xl-8 col-xxl-8">
						   <label>Class By</label>
						   <input type="text" class="form-control mb-3" placeholder="name" name="class_by" required>
						</div>
						</div>
						</div>
...
var table = $('#datatable').DataTable({
		...
		ajax:
		{
			url:"view-recorded-live-classes",
			data: function (data) 
		    {
...
$('#datatable tbody').on( 'click', '.edit', function ()
  {
	...
	var Result=$("#BasicModal2 .modal-body");
		...
		//$(this).attr('data-bs-target','#BasicModal2');
			...
			jQuery.ajax({
			type: "GET",
			url: "edit-recorded-live-class"+"/"+id,
			dataType: 'html',
			//data: {vid: vid},
	...
	Swal.fire({
	  ...
	  if (result.isConfirmed) {
		...
		var id=$(this).attr('id');
		  jQuery.ajax({
			type: "get",
			url: "delete-recorded-live-class"+"/"+id,
			dataType: 'json',
			//data: {vid: vid},
			success: function(res)
			{
	...
	Swal.fire({
	  ...
	  if (result.isConfirmed) {
		var id=$(this).attr('id');
		  jQuery.ajax({
			type: "get",
			url: "act-deact-recorded-live-class/1"+"/"+id,
			dataType: 'json',
			//data: {vid: vid},
			success: function(res)
			{
	...
	Swal.fire({
	  ...
	  if (result.isConfirmed) {
		var id=$(this).attr('id');
		  jQuery.ajax({
			type: "get",
			url: "act-deact-recorded-live-class/2"+"/"+id,
			dataType: 'json',
			//data: {vid: vid},
			success: function(res)
			{
