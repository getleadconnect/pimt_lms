...
<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
              <div class="breadcrumb-title pe-3">Edit terms</div>
                     ...
                     <div class="col-12 col-lg-12 ">
                      <div class="card  shadow-none w-100">
						...
						@csrf
							...
							<textarea id="privacy_terms" class="form-control mb-3" name="policy" placeholder="Enter data" required>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. </textarea>
							</div>
							</div>
							</div>
