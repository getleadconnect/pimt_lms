...
<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
              <div class="breadcrumb-title pe-3">Model Test Results</div>
            ...
            <!--end breadcrumb-->
              ...
              <div class="card">
				...
				<div class="col-lg-9 col-xl-9 col-xxl-9 col-9">
                  <h6 class="mb-0 pt5">Test Results </h6>
				  </div>
                          ...
                          <div class="accordion-body">
						   <div class="row" style="padding:3px 10px 0px 10px;" >
							...
							<div class="col-3 col-lg-3">
								...
								<select class="form-control mb-3" id="flt_qpaper" placeholder="question paper" >
								<option value="">select</option>
								@foreach($qpaper as $r)
								<option value="{{$r->id}}">{{$r->question_paper_name}}</option>
								@endforeach
								</select>
							</div>
...
var table = $('#datatable').DataTable({
		...
		ajax:
		{
			url:"view-test-results",
			data: function (data) 
		    {
               data.search = $('input[type="search"]').val();
			   data.searchQpaper = $('#flt_qpaper').val();
		    },
        },
...
$("#flt_course").change(function()
{
	...
	jQuery.ajax({
			type: "GET",
			url: "get-qpapers-for-test-results"+"/"+id,
			dataType: 'html',
			//data: {vid: vid},
