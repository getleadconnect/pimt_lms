            ...
            <!--end breadcrumb-->
              ...
              <div class="card">
				...
				<div class="col-lg-9 col-xl-9 col-xxl-9 col-9">
                  <h6 class="mb-0 pt5">Staff List</h6>
				  </div>
			  ...
			  <div class="modal fade" id="BasicModal1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<label>Center</label>
						<select class="form-control mb-3" name="center_id" required>
						<option value="">select</option>
							@foreach($center as $r)
								<option value="{{$r->id}}">{{$r->center_name}}</option>
							@endforeach
						...
						<div class="form-group">
						<label>Name</label>
						<input class="form-control mb-3" type="text" name="staff_name" placeholder="Name" required>
						</div>
						<div class="form-group">
						<label>Address</label>
						<textarea class="form-control mb-3" type="text" name="address" placeholder="Name" required></textarea>
						</div>
						...
						<input class="form-control mb-3" type="text" name="ref_code" placeholder="Code" required>
						</div>
						
						<div class="col-lg-3 col-xl-3 col-xxl-3">
						<label>Percentage(%)</label>
						<input class="form-control mb-3" type="number" name="percentage" placeholder="percentage"  required>
						</div>
						</div>
						</div>
